...
class PlanningGraph():
    ...
    def create_graph(self):
        ...
        leveled = False
        level = 0
        self.s_levels.append(set())  # S0 set of s_nodes
        ...
        # Build graph alternating A, S levels until last two S levels contains same literals,
        while not leveled:
    ...
    def add_action_level(self, level):
        ...
        """
        # Implemented add action A level to the planning graph as described in the Russell-Norvig text
    ...
    def add_literal_level(self, level):
        ...
        """
        # Implemented add literal S level to the planning graph as described in the Russell-Norvig text
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        # Implemented test for Inconsistent Effects between nodes
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        # Implemented test for Interference between nodes
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        # Implemented test for Competing Needs between nodes
    ...
    def negation_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s) -> bool:
        ...
        :return: bool
        """
        # Implemented test for negation between nodes
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        :return: bool
        """
        # Implemented test for Inconsistent Support between nodes
